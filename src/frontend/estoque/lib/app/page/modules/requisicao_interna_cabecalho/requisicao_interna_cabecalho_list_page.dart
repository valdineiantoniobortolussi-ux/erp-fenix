...
class RequisicaoInternaCabecalhoListPage extends GetView<RequisicaoInternaCabecalhoController> {
	const RequisicaoInternaCabecalhoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Requisicao Interna'),
				actions: [
