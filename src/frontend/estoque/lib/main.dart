...
import 'package:estoque/app/data/provider/drift/platform/platform.dart';
import 'package:estoque/app/page/shared_page/splash_screen_page.dart';
import 'package:estoque/app/routes/app_pages.dart';
import 'package:estoque/app/translations/app_translation.dart';
import 'app/data/provider/drift/database/database.dart';

void main() async {
  Get.lazyPut(() => AppDatabase(Platform.createDatabaseConnection('estoque')));
