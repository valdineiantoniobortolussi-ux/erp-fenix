...
class PontoHorarioAutorizadoListPage extends GetView<PontoHorarioAutorizadoController> {
	const PontoHorarioAutorizadoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Horário Autorizado'),
				actions: [
