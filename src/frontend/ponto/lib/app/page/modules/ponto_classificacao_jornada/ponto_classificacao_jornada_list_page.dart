...
class PontoClassificacaoJornadaListPage extends GetView<PontoClassificacaoJornadaController> {
	const PontoClassificacaoJornadaListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Classificação da Jornada'),
				actions: [
