...
class PontoBancoHorasUtilizacaoListPage extends GetView<PontoBancoHorasUtilizacaoController> {
	const PontoBancoHorasUtilizacaoListPage({Key? key}) : super(key: key);
