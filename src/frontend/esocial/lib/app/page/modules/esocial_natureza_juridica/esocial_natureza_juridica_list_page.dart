...
class EsocialNaturezaJuridicaListPage extends GetView<EsocialNaturezaJuridicaController> {
	const EsocialNaturezaJuridicaListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Natureza Jurídica'),
				actions: [
