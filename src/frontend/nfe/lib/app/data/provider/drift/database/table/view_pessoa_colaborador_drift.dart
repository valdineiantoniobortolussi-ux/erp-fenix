...
@DataClassName("ViewPessoaColaborador")
class ViewPessoaColaboradors extends Table {
	@override
	String get tableName => 'view_pessoa_colaborador';
...
class ViewPessoaColaboradorGrouped {
	ViewPessoaColaborador? viewPessoaColaborador; 

  ViewPessoaColaboradorGrouped({
