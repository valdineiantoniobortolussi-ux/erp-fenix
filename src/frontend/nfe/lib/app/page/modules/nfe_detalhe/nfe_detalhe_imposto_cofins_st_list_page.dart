...
class NfeDetalheImpostoCofinsStListPage extends GetView<NfeDetalheImpostoCofinsStController> {
	const NfeDetalheImpostoCofinsStListPage({Key? key}) : super(key: key);
