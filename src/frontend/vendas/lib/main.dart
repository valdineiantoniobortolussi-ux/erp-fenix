...
import 'package:vendas/app/data/provider/drift/platform/platform.dart';
import 'package:vendas/app/page/shared_page/splash_screen_page.dart';
import 'package:vendas/app/routes/app_pages.dart';
import 'package:vendas/app/translations/app_translation.dart';
import 'app/data/provider/drift/database/database.dart';

void main() async {
  Get.lazyPut(() => AppDatabase(Platform.createDatabaseConnection('vendas')));
