...
import 'package:agenda/app/infra/session.dart';

class Constants {
	Constants._();

	static const String appName =	'T2Ti ERP 3.0 - Agenda Corporativa';
	...
	static String serverAddressComplement = '';//'/erp3/agenda';
	static String serverPort = '8091';		 

	// sh server
	static String serverShAddress = 'http://localhost';
	static String serverShAddressComplement = '';
	static String serverShPort = '3001';	

  // security
  static String serverLanguage = "NODE";
