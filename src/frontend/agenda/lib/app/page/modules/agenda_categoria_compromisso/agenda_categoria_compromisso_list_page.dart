...
class AgendaCategoriaCompromissoListPage extends GetView<AgendaCategoriaCompromissoController> {
	const AgendaCategoriaCompromissoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Categoria Compromisso'),
				actions: [
