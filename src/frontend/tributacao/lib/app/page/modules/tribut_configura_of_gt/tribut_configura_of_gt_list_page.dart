...
class TributConfiguraOfGtListPage extends GetView<TributConfiguraOfGtController> {
	const TributConfiguraOfGtListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Configura Tributação'),
				actions: [
