...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    runCancellable(operation, $T) {
      var token = new A.CancellationToken(new A._SyncCompleter(new A._Future($.Zone__current, $T._eval$1("_Future<0>")), $T._eval$1("_SyncCompleter<0>")), A._setArrayType([], type$.JSArray_of_void_Function), $T._eval$1("CancellationToken<0>")),
        t1 = type$.nullable_Object;
      A.runZoned(new A.runCancellable_closure(token, operation, $T), A.LinkedHashMap_LinkedHashMap$_literal([B.Symbol_hNH, token], t1, t1), type$.void);
      return token;
    },
    checkIfCancelled() {
    ...
    PortToChannel_channel(_this) {
      ...
      controller.__StreamChannelController__local_F = t4;
      ...
      controller.__StreamChannelController__foreign_F = t1;
      ...
      new A._ControllerStream(t4, A._instanceType(t4)._eval$1("_ControllerStream<1>")).listen$2$onDone(B.MessagePort_methods.get$postMessage(_this), new A.PortToChannel_channel_closure0(false, _this));
      return t1;
    },
  ...
  A.DriftCommunication_closure.prototype = {
    call$0() {
      var t1, t2, t3;
      for (t1 = this.$this, t2 = t1._pendingRequests, t3 = new A.LinkedHashMapValueIterator(t2, t2._modifications, t2._first, A._instanceType(t2)._eval$1("LinkedHashMapValueIterator<2>")); t3.moveNext$0();)
  ...
  A.DriftCommunication_setRequestHandler_closure.prototype = {
    ...
    $call$body$DriftCommunication_setRequestHandler_closure(request) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, e, s, t1, exception, t2, response, $async$exception;
  ...
  A.DriftProtocol.prototype = {
    ...
    decodePayload$1(encoded) {
      var tag, t1, readInt, readNullableInt, method, sql, args, t2, i, list, updates, encodedUpdate, kindIndex, t3, columnCount, columns, rows, result, t4, t5, t6, rowOffset, t7, c, _box_0 = {};
      ...
      switch (tag) {
        ...
        case 3:
          ...
          args = A.List_List$_of(t1, t1.$ti._eval$1("ListIterable.E"));
          return new A.ExecuteQuery(method, sql, args, readNullableInt.call$1(4));
        case 4:
          t1.toString;
        ...
        case 5:
          return new A.RunTransactionAction(B.JSArray_methods.$index(B.List_KeH, readInt.call$1(1)), readNullableInt.call$1(2));
        case 6:
          ...
          while (true) {
            ...
            if (kindIndex == null)
              ...
              if (kindIndex >>> 0 !== kindIndex || kindIndex >= 3)
                return A.ioore(B.List_L4j, kindIndex);
              t3 = B.List_L4j[kindIndex];
            }
  ...
  A.ServerImplementation.prototype = {
    ...
    _transactionControl$body$ServerImplementation(comm, action, executorId) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$next = [], $async$self = this, executor;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 8:
              // case
              $async$goto = 10;
              return A._asyncAwait(executor.send$0(0), $async$_transactionControl$3);
            case 10:
              // returning from await.
              executorId.toString;
  ...
  A.DatabaseConnection.prototype = {
    beginTransaction$0() {
      return this.executor.beginTransaction$0();
    },
    ensureOpen$1(user) {
  ...
  A._StatementBasedTransactionExecutor.prototype = {
    ensureOpen$1(user) {
      ...
      if (opened == null) {
        opened = _this._opened = new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_bool), type$._AsyncCompleter_bool);
  ...
  A.DelegatedDatabase_ensureOpen_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.bool),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, e, s, t2, _0_0, t3, exception, t1, $async$exception;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $async$self.$this;
              if (t1._closed) {
                t1 = A._interceptUserError(new A.StateError("Can't re-open a database after closing it. Please create a new database connection and open that instead."), null);
            ...
            case 6:
              ...
              e = A.unwrapException($async$exception);
              s = A.getTraceFromException($async$exception);
              t1._migrationError = new A._Record_2(e, s);
  ...
  (function installTearOffs() {
    ...
    _instance(A._Completer.prototype, "get$completeError", 0, 1, null, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 21, 0, 0);
    _instance(A._AsyncCompleter.prototype, "get$complete", 1, 0, function() {
      return [null];
    }, ["call$1", "call$0"], ["complete$1", "complete$0"], 63, 0, 0);
    ...
    _instance(A.MessagePort.prototype, "get$postMessage", 1, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["postMessage$2", "postMessage$1"], 59, 0, 0);
    _static_1(A, "js___convertToDart$closure", "_convertToDart", 78);
    _instance_1_u(A.DriftCommunication.prototype, "get$_handleMessage", "_handleMessage$1", 17);
    _instance_1_u(A.DriftProtocol.prototype, "get$_decodeDbValue", "_decodeDbValue$1", 29);
    ...
    _static_1(A, "sql_js_SqlJsModule_____tearOff$closure", "SqlJsModule_____tearOff", 80);
  ...
  (function inheritance() {
    ...
    _inheritMany(A._Enum, [A.NoArgsRequest, A.StatementMethod, A.TransactionControl, A.UpdateKind, A.SqlDialect]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(String,@)", "bool(String)", "~(@)", "Frame()", "Frame(String)", "~(Event)", "@(@)", "Null()", "~(Object,StackTrace)", "~(@,@)", "Future<~>()", "Null(Event)", "~(~())", "String(int)", "String(String)", "Trace(String)", "~(Object?)", "@()", "int(int,int)", "int(int)", "~(Object[StackTrace?])", "~(String,String)", "Null(@)", "bool()", "bool(~)", "Future<int>()", "int(Frame)", "String(Frame)", "Object?(Object?)", "~(Object?,Object?)", "Null(@,@)", "@(@,@)", "Null(@,StackTrace)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "Future<~>(Request)", "~(Symbol0,@)", "int?(int)", "Null(~)", "@(Request)", "~(String,int)", "Future<@>()", "CancellationToken<@>?()", "Future<QueryResult>()", "~(String,int?)", "Future<Null>()", "int()", "Future<bool>()", "Map<String,@>(List<Object?>)", "~(MessageEvent)", "~(VersionChangeEvent)", "~(int,@)", "String(String?)", "0^(0^,0^)<num>", "int(Trace)", "Null(bool)", "String(Trace)", "~(@[List<Object>?])", "@(@,String)", "Frame(String,String)", "Trace()", "~([Object?])", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "~(String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "Object?(@)", "Null(~())", "SqlJsModule(_SqlJs)", "Null(Object,StackTrace)", "@(String)", "List<Frame>(Trace)"],
...
;
    ...
    B.List_11 = makeConstList([11], type$.JSArray_int);
    ...
    B.List_KeH = makeConstList([B.TransactionControl_0, B.TransactionControl_1, B.TransactionControl_2], A.findType("JSArray<TransactionControl>"));
    B.UpdateKind_0 = new A.UpdateKind(0, "insert");
    B.UpdateKind_1 = new A.UpdateKind(1, "update");
    B.UpdateKind_2 = new A.UpdateKind(2, "delete");
    B.List_L4j = makeConstList([B.UpdateKind_0, B.UpdateKind_1, B.UpdateKind_2], A.findType("JSArray<UpdateKind>"));
    ...
    B.List_rcv = makeConstList([B.SqlDialect_0_sqlite, B.SqlDialect_1_mysql, B.SqlDialect_2_postgres, B.SqlDialect_3_mariadb], A.findType("JSArray<SqlDialect>"));
    ...
    B.List_s6K = makeConstList([B.StatementMethod_0, B.StatementMethod_1, B.StatementMethod_2, B.StatementMethod_3], A.findType("JSArray<StatementMethod>"));
    B.Object_empty = {};
    ...
    B.List_empty2 = makeConstList([], type$.JSArray_Map_of_String_and_nullable_Object);
