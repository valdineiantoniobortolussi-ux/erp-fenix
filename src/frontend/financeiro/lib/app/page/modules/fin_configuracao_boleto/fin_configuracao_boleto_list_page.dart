...
class FinConfiguracaoBoletoListPage extends GetView<FinConfiguracaoBoletoController> {
	const FinConfiguracaoBoletoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Configuracões Boleto'),
				actions: [
