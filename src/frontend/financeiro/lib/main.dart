...
import 'package:financeiro/app/data/provider/drift/platform/platform.dart';
import 'package:financeiro/app/page/shared_page/splash_screen_page.dart';
import 'package:financeiro/app/routes/app_pages.dart';
import 'package:financeiro/app/translations/app_translation.dart';
import 'app/data/provider/drift/database/database.dart';

void main() async {
  Get.lazyPut(() => AppDatabase(Platform.createDatabaseConnection('financeiro')));
