...
import 'package:contratos/app/data/provider/drift/platform/platform.dart';
import 'package:contratos/app/page/shared_page/splash_screen_page.dart';
import 'package:contratos/app/routes/app_pages.dart';
import 'package:contratos/app/translations/app_translation.dart';
import 'app/data/provider/drift/database/database.dart';

void main() async {
  Get.lazyPut(() => AppDatabase(Platform.createDatabaseConnection('contratos')));
