...
class ContratoHistoricoReajusteListPage extends GetView<ContratoHistoricoReajusteController> {
	const ContratoHistoricoReajusteListPage({Key? key}) : super(key: key);
