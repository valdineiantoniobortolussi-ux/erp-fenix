...
class GuiasAcumuladasListPage extends GetView<GuiasAcumuladasController> {
	const GuiasAcumuladasListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Guias Acumuladas'),
				actions: [
