...
class EmpresaTransporteItinerarioListPage extends GetView<EmpresaTransporteItinerarioController> {
	const EmpresaTransporteItinerarioListPage({Key? key}) : super(key: key);
