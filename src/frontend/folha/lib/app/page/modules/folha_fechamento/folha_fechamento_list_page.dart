...
class FolhaFechamentoListPage extends GetView<FolhaFechamentoController> {
	const FolhaFechamentoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Fechamento da Folha'),
				actions: [
