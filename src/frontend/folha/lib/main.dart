...
import 'package:folha/app/data/provider/drift/platform/platform.dart';
import 'package:folha/app/page/shared_page/splash_screen_page.dart';
import 'package:folha/app/routes/app_pages.dart';
import 'package:folha/app/translations/app_translation.dart';
import 'app/data/provider/drift/database/database.dart';

void main() async {
  Get.lazyPut(() => AppDatabase(Platform.createDatabaseConnection('folha')));
