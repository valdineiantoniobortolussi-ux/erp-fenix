...
import 'package:mdfe/app/data/provider/drift/platform/platform.dart';
import 'package:mdfe/app/page/shared_page/splash_screen_page.dart';
import 'package:mdfe/app/routes/app_pages.dart';
import 'package:mdfe/app/translations/app_translation.dart';
import 'app/data/provider/drift/database/database.dart';

void main() async {
  Get.lazyPut(() => AppDatabase(Platform.createDatabaseConnection('mdfe')));
