...
@DataClassName("MdfeMunicipioCarregamento")
class MdfeMunicipioCarregamentos extends Table {
	@override
	String get tableName => 'mdfe_municipio_carregamento';
