...
class MdfeInformacaoCteListPage extends GetView<MdfeInformacaoCteController> {
	const MdfeInformacaoCteListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Informacão CTE'),
				actions: [
