...
class MdfeRodoviarioVeiculoListPage extends GetView<MdfeRodoviarioVeiculoController> {
	const MdfeRodoviarioVeiculoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Rodoviario Veiculo'),
				actions: [
