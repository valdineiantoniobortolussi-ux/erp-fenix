...
class MdfeRodoviarioPedagioListPage extends GetView<MdfeRodoviarioPedagioController> {
	const MdfeRodoviarioPedagioListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Rodoviario Pedagio'),
				actions: [
