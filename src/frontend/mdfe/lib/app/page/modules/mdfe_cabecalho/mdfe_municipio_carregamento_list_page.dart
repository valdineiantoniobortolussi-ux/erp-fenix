...
class MdfeMunicipioCarregamentoListPage extends GetView<MdfeMunicipioCarregamentoController> {
	const MdfeMunicipioCarregamentoListPage({Key? key}) : super(key: key);
