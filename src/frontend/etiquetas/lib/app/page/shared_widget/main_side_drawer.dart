              ...
              style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 10.0),
					...
					ListTile(
						enabled: Session.loggedInUser.administrador == 'S'
							? true
								: Session.accessControlList.where( ((t) => t.funcaoNome == 'etiqueta_formato_papel') ).toList().isNotEmpty
									? Session.accessControlList.where( ((t) => t.funcaoNome == 'etiqueta_formato_papel') ).toList()[0].habilitado == 'S'
									: false,
						onTap: () {
							Get.toNamed(Routes.etiquetaFormatoPapelListPage);
						},
						title: const Text(
							'Formato do Papel',
            ...
            child: Text(
              ...
              style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 10.0),
					...
					ListTile(
						enabled: Session.loggedInUser.administrador == 'S'
							? true
								: Session.accessControlList.where( ((t) => t.funcaoNome == 'etiqueta_layout') ).toList().isNotEmpty
									? Session.accessControlList.where( ((t) => t.funcaoNome == 'etiqueta_layout') ).toList()[0].habilitado == 'S'
									: false,
						onTap: () {
							Get.toNamed(Routes.etiquetaLayoutListPage);
						},
						title: const Text(
							'Layout',
							style: TextStyle(fontWeight: FontWeight.w700, fontSize: 18.0),
