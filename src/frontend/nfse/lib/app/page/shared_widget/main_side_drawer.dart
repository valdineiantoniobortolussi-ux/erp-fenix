              ...
              style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 10.0),
					...
					ListTile(
						enabled: Session.loggedInUser.administrador == 'S'
							? true
								: Session.accessControlList.where( ((t) => t.funcaoNome == 'nfse_lista_servico') ).toList().isNotEmpty
									? Session.accessControlList.where( ((t) => t.funcaoNome == 'nfse_lista_servico') ).toList()[0].habilitado == 'S'
									: false,
						onTap: () {
							Get.toNamed(Routes.nfseListaServicoListPage);
						},
						title: const Text(
							'Lista de Serviços',
            ...
            child: Text(
              ...
              style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 10.0),
					...
					ListTile(
						enabled: Session.loggedInUser.administrador == 'S'
							? true
								: Session.accessControlList.where( ((t) => t.funcaoNome == 'nfse_cabecalho') ).toList().isNotEmpty
									? Session.accessControlList.where( ((t) => t.funcaoNome == 'nfse_cabecalho') ).toList()[0].habilitado == 'S'
									: false,
						onTap: () {
							Get.toNamed(Routes.nfseCabecalhoListPage);
						},
						title: const Text(
							'NFS-e',
							style: TextStyle(fontWeight: FontWeight.w700, fontSize: 18.0),
