...
(function dartProgram() {
  ...
  A.DriftProtocol.prototype = {
    ...
    decodePayload$1(encoded) {
      var tag, t1, readInt, readNullableInt, method, sql, args, t2, i, list, t3, t4, t5, updates, encodedUpdate, kindIndex, columnCount, columns, rows, result, t6, rowOffset, t7, c, _box_0 = {};
  ...
  (function installTearOffs() {
    ...
    _instance(A.MessagePort.prototype, "get$postMessage", 1, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["postMessage$2", "postMessage$1"], 57, 0, 0);
    ...
    _instance_1_u(A.DriftProtocol.prototype, "get$_decodeDbValue", "_decodeDbValue$1", 30);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(String,@)", "bool(String)", "~(@)", "Frame()", "Frame(String)", "Future<~>()", "~(Event)", "@(@)", "Null()", "~(Object,StackTrace)", "~(@,@)", "Null(Event)", "~(~())", "String(int)", "String(String)", "Trace(String)", "~(Object?)", "@()", "int(int,int)", "int(int)", "~(Object[StackTrace?])", "~(String,String)", "Null(@)", "bool()", "bool(~)", "Future<int>()", "Future<Null>()", "int(Frame)", "String(Frame)", "Object?(Object?)", "Null(@,@)", "@(@,@)", "Null(@,StackTrace)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "Future<~>(Request)", "~(Symbol0,@)", "int?(int)", "Null(~)", "@(Request)", "~(String,int)", "Future<@>()", "CancellationToken<@>?()", "Future<QueryResult>()", "~(String,int?)", "Null(bool)", "int()", "Future<bool>()", "Map<String,@>(List<Object?>)", "~(MessageEvent)", "~(VersionChangeEvent)", "~(int,@)", "String(String?)", "0^(0^,0^)<num>", "int(Trace)", "~(@[List<Object>?])", "String(Trace)", "@(@,String)", "~(Object?,Object?)", "Frame(String,String)", "Trace()", "~([Object?])", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "~(String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "Object?(@)", "Null(~())", "SqlJsModule(_SqlJs)", "Null(Object,StackTrace)", "@(String)", "List<Frame>(Trace)"],
...
;
    ...
    B.List_ttt = makeConstList([B.NestedExecutorControl_0, B.NestedExecutorControl_1, B.NestedExecutorControl_2, B.NestedExecutorControl_3, B.NestedExecutorControl_4], A.findType("JSArray<NestedExecutorControl>"));
    B.Object_empty = {};
