...
class ContabilLancamentoPadraoListPage extends GetView<ContabilLancamentoPadraoController> {
	const ContabilLancamentoPadraoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Lancamento Padrão'),
				actions: [
