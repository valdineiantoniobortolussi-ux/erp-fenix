...
class PlanoContaRefSpedListPage extends GetView<PlanoContaRefSpedController> {
	const PlanoContaRefSpedListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Planos de Contas Sped'),
				actions: [
