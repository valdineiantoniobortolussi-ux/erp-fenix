...
class PlanoCentroResultadoListPage extends GetView<PlanoCentroResultadoController> {
	const PlanoCentroResultadoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Plano Centro Resultado'),
				actions: [
