...
class ContabilEncerramentoExeCabListPage extends GetView<ContabilEncerramentoExeCabController> {
	const ContabilEncerramentoExeCabListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Encerramento do Exercício'),
				actions: [
