...
class EncerraCentroResultadoListPage extends GetView<EncerraCentroResultadoController> {
	const EncerraCentroResultadoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Encerra Centro Resultado'),
				actions: [
