...
class ContabilLancamentoOrcadoListPage extends GetView<ContabilLancamentoOrcadoController> {
	const ContabilLancamentoOrcadoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Lançamento Orcado'),
				actions: [
