...
class RateioCentroResultadoCabListPage extends GetView<RateioCentroResultadoCabController> {
	const RateioCentroResultadoCabListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Rateio Centro Resultado'),
				actions: [
