...
import 'package:contabil/app/data/provider/api/empresa_api_provider.dart';
import 'package:contabil/app/data/provider/api/lookup_api_provider.dart';
import 'package:contabil/app/data/provider/drift/lookup_drift_provider.dart';
import 'package:contabil/app/data/repository/lookup_repository.dart';
...
class Session {
  ...
  // await verificarEmpresaPlanoAtivo(); // Comentado para garantir que mostre a tela de login
  // await isItCalledByAnotherModule(); // Comentado para não pular login
}
