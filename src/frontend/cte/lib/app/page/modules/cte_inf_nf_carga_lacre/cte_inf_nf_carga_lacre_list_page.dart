...
class CteInfNfCargaLacreListPage extends GetView<CteInfNfCargaLacreController> {
	const CteInfNfCargaLacreListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Cte Inf Nf Carga Lacre'),
				actions: [
