...
import 'package:cte/app/controller/cte_destinatario_controller.dart';
import 'package:cte/app/page/shared_widget/shared_widget_imports.dart';

class CteDestinatarioListPage extends GetView<CteDestinatarioController> {
	const CteDestinatarioListPage({Key? key}) : super(key: key);
