...
import 'package:cte/app/controller/cte_expedidor_controller.dart';
import 'package:cte/app/page/shared_widget/shared_widget_imports.dart';

class CteExpedidorListPage extends GetView<CteExpedidorController> {
	const CteExpedidorListPage({Key? key}) : super(key: key);
