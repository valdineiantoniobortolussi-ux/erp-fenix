...
class CteRodoviarioOccListPage extends GetView<CteRodoviarioOccController> {
	const CteRodoviarioOccListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Cte Rodoviario Occ'),
				actions: [
