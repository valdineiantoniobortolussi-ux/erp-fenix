...
class CteInfNfTransporteLacreListPage extends GetView<CteInfNfTransporteLacreController> {
	const CteInfNfTransporteLacreListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Cte Inf Nf Transporte Lacre'),
				actions: [
