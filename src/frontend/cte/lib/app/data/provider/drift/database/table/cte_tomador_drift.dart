...
@DataClassName("CteTomador")
class CteTomadors extends Table {
	@override
	String get tableName => 'cte_tomador';
	...
	TextColumn get logradouro => text().named('logradouro').withLength(min: 0, max: 255).nullable()();
