...
class CteTomadorModel {
	...
	CteTomadorModel.fromJson(Map<String, dynamic> jsonData) {
		id = jsonData['id'];
		...
		uf = CteTomadorDomain.getUf(jsonData['uf']);
		cep = jsonData['cep'];
	...
	Map<String, dynamic> get toJson {
		...
		jsonData['uf'] = CteTomadorDomain.setUf(uf);
	...
	CteTomadorModel clone() {
		return CteTomadorModel(
			id: id,
