...
@DataClassName("CompraTipoPedido")
class CompraTipoPedidos extends Table {
	@override
	String get tableName => 'compra_tipo_pedido';
...
class CompraTipoPedidoGrouped {
	CompraTipoPedido? compraTipoPedido; 

  CompraTipoPedidoGrouped({
