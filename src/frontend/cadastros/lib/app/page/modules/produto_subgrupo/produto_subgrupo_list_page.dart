...
class ProdutoSubgrupoListPage extends GetView<ProdutoSubgrupoController> {
	const ProdutoSubgrupoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Subgrupo Produto'),
				actions: [
