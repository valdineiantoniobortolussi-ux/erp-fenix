...
class TipoRelacionamentoListPage extends GetView<TipoRelacionamentoController> {
	const TipoRelacionamentoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Tipo Relacionamento'),
				actions: [
