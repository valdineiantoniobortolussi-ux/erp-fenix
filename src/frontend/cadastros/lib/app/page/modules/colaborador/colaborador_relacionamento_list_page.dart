...
class ColaboradorRelacionamentoListPage extends GetView<ColaboradorRelacionamentoController> {
	const ColaboradorRelacionamentoListPage({Key? key}) : super(key: key);
