...
@DataClassName("FiscalTermo")
class FiscalTermos extends Table {
	@override
	String get tableName => 'fiscal_termo';

	IntColumn get id => integer().named('id').nullable()();
	IntColumn get idFiscalLivro => integer().named('id_fiscal_livro').nullable()();
