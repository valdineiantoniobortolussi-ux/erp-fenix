...
class FiscalMunicipalRegimeListPage extends GetView<FiscalMunicipalRegimeController> {
	const FiscalMunicipalRegimeListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Regime Municipal'),
				actions: [
