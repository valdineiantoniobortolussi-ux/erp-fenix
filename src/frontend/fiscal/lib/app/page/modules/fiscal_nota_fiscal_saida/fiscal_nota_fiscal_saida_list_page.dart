...
class FiscalNotaFiscalSaidaListPage extends GetView<FiscalNotaFiscalSaidaController> {
	const FiscalNotaFiscalSaidaListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Registro de Saídas'),
				actions: [
