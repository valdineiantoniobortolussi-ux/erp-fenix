...
class FiscalApuracaoIcmsListPage extends GetView<FiscalApuracaoIcmsController> {
	const FiscalApuracaoIcmsListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Apuração do ICMS'),
				actions: [
