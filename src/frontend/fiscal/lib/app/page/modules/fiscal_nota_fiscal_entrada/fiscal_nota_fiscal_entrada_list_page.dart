...
class FiscalNotaFiscalEntradaListPage extends GetView<FiscalNotaFiscalEntradaController> {
	const FiscalNotaFiscalEntradaListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Registro de Entradas'),
				actions: [
