...
class EfdContribuicoesListPage extends GetView<EfdContribuicoesController> {
	const EfdContribuicoesListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('EFD Contribuições'),
				actions: [
