...
class OrcamentoPeriodoListPage extends GetView<OrcamentoPeriodoController> {
	const OrcamentoPeriodoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Períodos do Orçamento'),
				actions: [
