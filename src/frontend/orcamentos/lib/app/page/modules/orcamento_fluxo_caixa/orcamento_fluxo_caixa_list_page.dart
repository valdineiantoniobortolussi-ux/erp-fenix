...
class OrcamentoFluxoCaixaListPage extends GetView<OrcamentoFluxoCaixaController> {
	const OrcamentoFluxoCaixaListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Orçamento - Fluxo de Caixa'),
				actions: [
