...
class OrcamentoFluxoCaixaPeriodoListPage extends GetView<OrcamentoFluxoCaixaPeriodoController> {
	const OrcamentoFluxoCaixaPeriodoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Períodos - Fluxo de Caixa'),
				actions: [
