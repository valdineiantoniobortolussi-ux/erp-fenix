...
class PatrimTipoAquisicaoBemListPage extends GetView<PatrimTipoAquisicaoBemController> {
	const PatrimTipoAquisicaoBemListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Tipo Aquisição Bem'),
				actions: [
