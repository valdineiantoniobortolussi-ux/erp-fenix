...
import 'dart:math';
import 'package:projetos/app/controller/theme_controller.dart';
              ...
              style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 10.0),
					...
					ListTile(
						enabled: Session.loggedInUser.administrador == 'S'
							? true
								: Session.accessControlList.where( ((t) => t.funcaoNome == 'projeto_principal') ).toList().isNotEmpty
									? Session.accessControlList.where( ((t) => t.funcaoNome == 'projeto_principal') ).toList()[0].habilitado == 'S'
									: false,
						onTap: () {
							Get.toNamed(Routes.projetoPrincipalListPage);
						},
						title: const Text(
							'Projeto',
