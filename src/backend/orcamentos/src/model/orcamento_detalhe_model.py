...
class OrcamentoDetalheModel(db.Model):
    __tablename__ = 'orcamento_detalhe'
    ...
    id_orcamento_empresarial = db.Column(db.Integer, db.ForeignKey('orcamento_empresarial.id'))
    ...
    def mapping(self, data):
        self.id = data.get('id')
        self.id_orcamento_empresarial = data.get('idOrcamentoEmpresarial')
    ...
    def serialize(self):
        return {
            'id': self.id,
            'idOrcamentoEmpresarial': self.id_orcamento_empresarial,
