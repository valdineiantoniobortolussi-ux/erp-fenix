...
class NfeLocalEntregaModel(db.Model):
    __tablename__ = 'nfe_local_entrega'

    id = db.Column(db.Integer, primary_key=True)
    cnpj = db.Column(db.String(14))
    cpf = db.Column(db.String(11))
    nome_recebedor = db.Column(db.String(60))
    ...
    def mapping(self, data):
        ...
        self.nome_recebedor = data.get('nomeRecebedor')
    ...
    def serialize(self):
        return {
            ...
            'cnpj': self.cnpj,
            'cpf': self.cpf,
            'nomeRecebedor': self.nome_recebedor,
