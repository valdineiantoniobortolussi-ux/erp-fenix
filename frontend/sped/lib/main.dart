...
import 'package:sped/app/data/provider/drift/platform/platform.dart';
import 'package:sped/app/page/shared_page/splash_screen_page.dart';
import 'package:sped/app/routes/app_pages.dart';
import 'package:sped/app/translations/app_translation.dart';
import 'app/data/provider/drift/database/database.dart';

void main() async {
  Get.lazyPut(() => AppDatabase(Platform.createDatabaseConnection('sped')));
