...
class EstoqueReajusteCabecalhoListPage extends GetView<EstoqueReajusteCabecalhoController> {
	const EstoqueReajusteCabecalhoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Reajuste de Preços'),
				actions: [
