...
class AgendaCompromissoConvidadoListPage extends GetView<AgendaCompromissoConvidadoController> {
	const AgendaCompromissoConvidadoListPage({Key? key}) : super(key: key);
