...
import 'package:pcp/app/data/provider/drift/platform/platform.dart';
import 'package:pcp/app/page/shared_page/splash_screen_page.dart';
import 'package:pcp/app/routes/app_pages.dart';
import 'package:pcp/app/translations/app_translation.dart';
import 'app/data/provider/drift/database/database.dart';

void main() async {
  Get.lazyPut(() => AppDatabase(Platform.createDatabaseConnection('pcp')));
