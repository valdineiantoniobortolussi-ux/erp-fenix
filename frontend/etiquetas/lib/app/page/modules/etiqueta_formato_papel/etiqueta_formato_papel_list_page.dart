...
class EtiquetaFormatoPapelListPage extends GetView<EtiquetaFormatoPapelController> {
	const EtiquetaFormatoPapelListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Formato do Papel'),
				actions: [
