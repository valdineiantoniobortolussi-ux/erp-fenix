...
import 'package:etiquetas/app/data/provider/drift/platform/platform.dart';
import 'package:etiquetas/app/page/shared_page/splash_screen_page.dart';
import 'package:etiquetas/app/routes/app_pages.dart';
import 'package:etiquetas/app/translations/app_translation.dart';
import 'app/data/provider/drift/database/database.dart';

void main() async {
  Get.lazyPut(() => AppDatabase(Platform.createDatabaseConnection('etiquetas')));
