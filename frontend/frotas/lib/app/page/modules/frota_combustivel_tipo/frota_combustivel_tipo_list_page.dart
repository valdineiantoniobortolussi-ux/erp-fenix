...
class FrotaCombustivelTipoListPage extends GetView<FrotaCombustivelTipoController> {
	const FrotaCombustivelTipoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Tipo Combustível'),
				actions: [
