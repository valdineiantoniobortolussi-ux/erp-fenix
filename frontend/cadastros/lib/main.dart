...
import 'package:cadastros/app/data/provider/drift/platform/platform.dart';
import 'package:cadastros/app/page/shared_page/splash_screen_page.dart';
import 'package:cadastros/app/routes/app_pages.dart';
import 'package:cadastros/app/translations/app_translation.dart';
import 'app/data/provider/drift/database/database.dart';

void main() async {
  Get.lazyPut(() => AppDatabase(Platform.createDatabaseConnection('cadastros')));
