...
class ColaboradorSituacaoListPage extends GetView<ColaboradorSituacaoController> {
	const ColaboradorSituacaoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Situação Colaborador'),
				actions: [
