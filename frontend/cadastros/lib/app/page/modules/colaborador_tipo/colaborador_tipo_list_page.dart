...
class ColaboradorTipoListPage extends GetView<ColaboradorTipoController> {
	const ColaboradorTipoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Tipo Colaborador'),
				actions: [
