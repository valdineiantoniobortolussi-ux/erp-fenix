...
class NotaFiscalTipoListPage extends GetView<NotaFiscalTipoController> {
	const NotaFiscalTipoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Tipo de Nota Fiscal'),
				actions: [
