...
class FeriasPeriodoAquisitivoListPage extends GetView<FeriasPeriodoAquisitivoController> {
	const FeriasPeriodoAquisitivoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Períodos Aquisitivos'),
				actions: [
