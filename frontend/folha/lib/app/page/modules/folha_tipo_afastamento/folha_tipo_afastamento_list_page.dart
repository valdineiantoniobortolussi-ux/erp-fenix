...
class FolhaTipoAfastamentoListPage extends GetView<FolhaTipoAfastamentoController> {
	const FolhaTipoAfastamentoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Tipo de Afastamento'),
				actions: [
