...
class FolhaFeriasColetivasListPage extends GetView<FolhaFeriasColetivasController> {
	const FolhaFeriasColetivasListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Férias Coletivas'),
				actions: [
