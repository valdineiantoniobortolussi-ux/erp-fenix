...
class MdfeRodoviarioCiotListPage extends GetView<MdfeRodoviarioCiotController> {
	const MdfeRodoviarioCiotListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Rodoviario CIOT'),
				actions: [
