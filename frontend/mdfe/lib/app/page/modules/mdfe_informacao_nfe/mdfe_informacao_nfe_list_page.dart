...
class MdfeInformacaoNfeListPage extends GetView<MdfeInformacaoNfeController> {
	const MdfeInformacaoNfeListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Informacao NFe'),
				actions: [
