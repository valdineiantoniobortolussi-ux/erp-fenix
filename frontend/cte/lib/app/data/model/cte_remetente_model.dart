...
class CteRemetenteModel {
	...
	CteRemetenteModel.fromJson(Map<String, dynamic> jsonData) {
		id = jsonData['id'];
		...
		uf = CteRemetenteDomain.getUf(jsonData['uf']);
		cep = jsonData['cep'];
	...
	Map<String, dynamic> get toJson {
		...
		jsonData['uf'] = CteRemetenteDomain.setUf(uf);
	...
	CteRemetenteModel clone() {
		return CteRemetenteModel(
			id: id,
