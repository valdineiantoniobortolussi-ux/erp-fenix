...
class CteExpedidorModel {
	...
	CteExpedidorModel.fromJson(Map<String, dynamic> jsonData) {
		id = jsonData['id'];
		...
		uf = CteExpedidorDomain.getUf(jsonData['uf']);
		cep = jsonData['cep'];
	...
	Map<String, dynamic> get toJson {
		...
		jsonData['uf'] = CteExpedidorDomain.setUf(uf);
	...
	CteExpedidorModel clone() {
		return CteExpedidorModel(
			id: id,
