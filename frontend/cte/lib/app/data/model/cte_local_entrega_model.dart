...
class CteLocalEntregaModel {
	...
	CteLocalEntregaModel.fromJson(Map<String, dynamic> jsonData) {
		id = jsonData['id'];
		...
		uf = CteLocalEntregaDomain.getUf(jsonData['uf']);
	}
	...
	Map<String, dynamic> get toJson {
		...
		jsonData['uf'] = CteLocalEntregaDomain.setUf(uf);
	...
	CteLocalEntregaModel clone() {
		return CteLocalEntregaModel(
			id: id,
