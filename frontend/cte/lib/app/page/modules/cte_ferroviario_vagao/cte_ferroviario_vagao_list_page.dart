...
class CteFerroviarioVagaoListPage extends GetView<CteFerroviarioVagaoController> {
	const CteFerroviarioVagaoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Cte Ferroviario Vagao'),
				actions: [
