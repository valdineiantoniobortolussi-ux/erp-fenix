...
class CteInformacaoNfTransporteListPage extends GetView<CteInformacaoNfTransporteController> {
	const CteInformacaoNfTransporteListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Cte Informacao Nf Transporte'),
				actions: [
