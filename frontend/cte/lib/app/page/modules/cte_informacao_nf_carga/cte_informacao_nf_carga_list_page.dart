...
class CteInformacaoNfCargaListPage extends GetView<CteInformacaoNfCargaController> {
	const CteInformacaoNfCargaListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Cte Informacao Nf Carga'),
				actions: [
