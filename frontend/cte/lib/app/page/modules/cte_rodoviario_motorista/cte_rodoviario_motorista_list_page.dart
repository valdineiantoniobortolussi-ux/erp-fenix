...
class CteRodoviarioMotoristaListPage extends GetView<CteRodoviarioMotoristaController> {
	const CteRodoviarioMotoristaListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Cte Rodoviario Motorista'),
				actions: [
