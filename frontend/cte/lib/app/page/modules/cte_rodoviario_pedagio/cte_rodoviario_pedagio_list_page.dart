...
class CteRodoviarioPedagioListPage extends GetView<CteRodoviarioPedagioController> {
	const CteRodoviarioPedagioListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Cte Rodoviario Pedagio'),
				actions: [
