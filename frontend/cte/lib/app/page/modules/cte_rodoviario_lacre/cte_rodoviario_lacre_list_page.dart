...
class CteRodoviarioLacreListPage extends GetView<CteRodoviarioLacreController> {
	const CteRodoviarioLacreListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Cte Rodoviario Lacre'),
				actions: [
