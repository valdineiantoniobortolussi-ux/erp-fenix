...
class CteDocumentoAnteriorIdListPage extends GetView<CteDocumentoAnteriorIdController> {
	const CteDocumentoAnteriorIdListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Cte Documento Anterior Id'),
				actions: [
