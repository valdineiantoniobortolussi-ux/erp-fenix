...
class CteFerroviarioFerroviaListPage extends GetView<CteFerroviarioFerroviaController> {
	const CteFerroviarioFerroviaListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Cte Ferroviario Ferrovia'),
				actions: [
