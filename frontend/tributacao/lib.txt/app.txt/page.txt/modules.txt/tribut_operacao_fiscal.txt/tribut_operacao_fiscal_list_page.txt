...
class TributOperacaoFiscalListPage extends GetView<TributOperacaoFiscalController> {
	const TributOperacaoFiscalListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Operação Fiscal'),
				actions: [
