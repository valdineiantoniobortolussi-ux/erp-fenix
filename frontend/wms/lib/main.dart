...
import 'package:wms/app/data/provider/drift/platform/platform.dart';
import 'package:wms/app/page/shared_page/splash_screen_page.dart';
import 'package:wms/app/routes/app_pages.dart';
import 'package:wms/app/translations/app_translation.dart';
import 'app/data/provider/drift/database/database.dart';

void main() async {
  Get.lazyPut(() => AppDatabase(Platform.createDatabaseConnection('wms')));
