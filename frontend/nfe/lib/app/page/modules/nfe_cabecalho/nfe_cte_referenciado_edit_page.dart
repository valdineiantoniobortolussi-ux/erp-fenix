...
class NfeCteReferenciadoEditPage extends StatelessWidget {
	...
	Widget build(BuildContext context) {
			return Scaffold(
				key: nfeCteReferenciadoController.scaffoldKey,	
				appBar: AppBar(
					automaticallyImplyLeading: false,
					title: Text('CTe Referenciado - ${'editing'.tr}'),
					actions: [
				...
				body: SafeArea(
					...
					bottom: false,
					child: Form(
						key: nfeCteReferenciadoController.formKey,
													...
													child: Padding(
														...
														child: TextFormField(
															...
															onChanged: (text) {
																...
																nfeCteReferenciadoController.formWasChanged = true;
															},
														),
													),
												),
