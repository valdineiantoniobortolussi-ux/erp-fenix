...
class NfeDetEspecificoCombustivelListPage extends GetView<NfeDetEspecificoCombustivelController> {
	const NfeDetEspecificoCombustivelListPage({Key? key}) : super(key: key);
