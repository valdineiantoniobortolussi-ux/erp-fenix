...
class NfeDetalheImpostoIcmsUfdestListPage extends GetView<NfeDetalheImpostoIcmsUfdestController> {
	const NfeDetalheImpostoIcmsUfdestListPage({Key? key}) : super(key: key);
