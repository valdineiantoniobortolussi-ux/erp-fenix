...
class NfeDetEspecificoMedicamentoListPage extends GetView<NfeDetEspecificoMedicamentoController> {
	const NfeDetEspecificoMedicamentoListPage({Key? key}) : super(key: key);
