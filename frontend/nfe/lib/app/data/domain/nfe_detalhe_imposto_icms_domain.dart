class NfeDetalheImpostoIcmsDomain {
	...
	static getCstIcms(String? cstIcms) { 
		switch (cstIcms) { 
			case '': 
			case '0': 
				return 'AAA'; 
	...
	static setCstIcms(String? cstIcms) { 
		switch (cstIcms) { 
			case 'AAA': 
				return '0'; 
			case 'BBB': 
	...
	static getMotivoDesoneracaoIcms(String? motivoDesoneracaoIcms) { 
		switch (motivoDesoneracaoIcms) { 
			case '': 
			case '0': 
				return 'AAA'; 
			case '1': 
	...
	static setMotivoDesoneracaoIcms(String? motivoDesoneracaoIcms) { 
		switch (motivoDesoneracaoIcms) { 
			case 'AAA': 
				return '0'; 
			case 'BBB': 
