...
@DataClassName("ViewPessoaCliente")
class ViewPessoaClientes extends Table {
	@override
	String get tableName => 'view_pessoa_cliente';
...
class ViewPessoaClienteGrouped {
	ViewPessoaCliente? viewPessoaCliente; 

  ViewPessoaClienteGrouped({
