...
@DataClassName("ViewPessoaTransportadora")
class ViewPessoaTransportadoras extends Table {
	@override
	String get tableName => 'view_pessoa_transportadora';
...
class ViewPessoaTransportadoraGrouped {
	ViewPessoaTransportadora? viewPessoaTransportadora; 

  ViewPessoaTransportadoraGrouped({
