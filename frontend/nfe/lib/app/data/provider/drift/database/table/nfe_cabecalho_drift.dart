...
class NfeCabecalhoGrouped {
  ...
  NfeCabecalhoGrouped({
		...
		this.nfeEmitenteGroupedList, 
		this.nfeDestinatarioGroupedList, 
		this.nfeLocalRetiradaGroupedList, 
		this.nfeLocalEntregaGroupedList, 
		this.nfeTransporteGroupedList, 
		this.nfeFaturaGroupedList, 
		this.nfeCanaGroupedList, 
		...
		this.nfeResponsavelTecnicoGroupedList, 
