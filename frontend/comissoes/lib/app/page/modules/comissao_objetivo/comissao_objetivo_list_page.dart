...
class ComissaoObjetivoListPage extends GetView<ComissaoObjetivoController> {
	const ComissaoObjetivoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Objetivos e Metas'),
				actions: [
