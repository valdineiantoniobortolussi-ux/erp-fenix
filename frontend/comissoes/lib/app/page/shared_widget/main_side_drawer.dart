...
import 'dart:math';
import 'package:comissoes/app/controller/theme_controller.dart';
              ...
              style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 10.0),
					...
					ListTile(
						enabled: Session.loggedInUser.administrador == 'S'
							? true
								: Session.accessControlList.where( ((t) => t.funcaoNome == 'comissao_perfil') ).toList().isNotEmpty
									? Session.accessControlList.where( ((t) => t.funcaoNome == 'comissao_perfil') ).toList()[0].habilitado == 'S'
									: false,
						onTap: () {
							Get.toNamed(Routes.comissaoPerfilListPage);
						},
						title: const Text(
							'Perfis',
					...
					ListTile(
						enabled: Session.loggedInUser.administrador == 'S'
							? true
								: Session.accessControlList.where( ((t) => t.funcaoNome == 'comissao_objetivo') ).toList().isNotEmpty
									? Session.accessControlList.where( ((t) => t.funcaoNome == 'comissao_objetivo') ).toList()[0].habilitado == 'S'
									: false,
						onTap: () {
							Get.toNamed(Routes.comissaoObjetivoListPage);
						},
						title: const Text(
							'Objetivos e Metas',
							style: TextStyle(fontWeight: FontWeight.w700, fontSize: 18.0),
