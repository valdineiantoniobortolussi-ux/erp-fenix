...
class ContratoSolicitacaoServicoListPage extends GetView<ContratoSolicitacaoServicoController> {
	const ContratoSolicitacaoServicoListPage({Key? key}) : super(key: key);
