...
@DataClassName("PatrimTipoAquisicaoBem")
class PatrimTipoAquisicaoBems extends Table {
	@override
	String get tableName => 'patrim_tipo_aquisicao_bem';
...
class PatrimTipoAquisicaoBemGrouped {
	PatrimTipoAquisicaoBem? patrimTipoAquisicaoBem; 

  PatrimTipoAquisicaoBemGrouped({
		this.patrimTipoAquisicaoBem, 
