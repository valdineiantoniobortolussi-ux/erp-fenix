...
class PatrimIndiceAtualizacaoListPage extends GetView<PatrimIndiceAtualizacaoController> {
	const PatrimIndiceAtualizacaoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Índices de Atualização'),
				actions: [
