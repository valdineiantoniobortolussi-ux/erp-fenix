...
class PatrimTipoMovimentacaoListPage extends GetView<PatrimTipoMovimentacaoController> {
	const PatrimTipoMovimentacaoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Tipo Movimentação Bem'),
				actions: [
