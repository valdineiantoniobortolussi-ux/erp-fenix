...
class InventarioContagemCabListPage extends GetView<InventarioContagemCabController> {
	const InventarioContagemCabListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Contagem de Produtos'),
				actions: [
