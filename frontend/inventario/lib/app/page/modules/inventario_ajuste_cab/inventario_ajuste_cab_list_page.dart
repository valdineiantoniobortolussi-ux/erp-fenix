...
class InventarioAjusteCabListPage extends GetView<InventarioAjusteCabController> {
	const InventarioAjusteCabListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Ajustes de Preço'),
				actions: [
