...
class FiscalInscricoesSubstitutasListPage extends GetView<FiscalInscricoesSubstitutasController> {
	const FiscalInscricoesSubstitutasListPage({Key? key}) : super(key: key);
