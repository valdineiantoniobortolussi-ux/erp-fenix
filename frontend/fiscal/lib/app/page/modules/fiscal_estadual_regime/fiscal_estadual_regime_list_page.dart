...
class FiscalEstadualRegimeListPage extends GetView<FiscalEstadualRegimeController> {
	const FiscalEstadualRegimeListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Regime Estadual'),
				actions: [
