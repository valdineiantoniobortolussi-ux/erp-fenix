...
class TalonarioChequeListPage extends GetView<TalonarioChequeController> {
	const TalonarioChequeListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Talonário Cheque'),
				actions: [
