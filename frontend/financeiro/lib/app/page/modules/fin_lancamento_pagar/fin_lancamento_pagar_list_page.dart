...
class FinLancamentoPagarListPage extends GetView<FinLancamentoPagarController> {
	const FinLancamentoPagarListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Lançamento a Pagar'),
				actions: [
