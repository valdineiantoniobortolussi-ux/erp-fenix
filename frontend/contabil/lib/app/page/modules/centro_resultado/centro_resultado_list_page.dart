...
class CentroResultadoListPage extends GetView<CentroResultadoController> {
	const CentroResultadoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Centro de Resultado'),
				actions: [
