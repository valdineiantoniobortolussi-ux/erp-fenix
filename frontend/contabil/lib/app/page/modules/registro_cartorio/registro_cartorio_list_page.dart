...
class RegistroCartorioListPage extends GetView<RegistroCartorioController> {
	const RegistroCartorioListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Registro em Cartório'),
				actions: [
