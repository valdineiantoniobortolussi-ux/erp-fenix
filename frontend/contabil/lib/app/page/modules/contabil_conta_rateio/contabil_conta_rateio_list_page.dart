...
class ContabilContaRateioListPage extends GetView<ContabilContaRateioController> {
	const ContabilContaRateioListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Rateio Conta Contábil'),
				actions: [
