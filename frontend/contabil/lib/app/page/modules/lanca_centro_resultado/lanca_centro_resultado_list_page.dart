...
class LancaCentroResultadoListPage extends GetView<LancaCentroResultadoController> {
	const LancaCentroResultadoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Lançamento Centro Resultado'),
				actions: [
