...
class ContabilEncerramentoExeDetListPage extends GetView<ContabilEncerramentoExeDetController> {
	const ContabilEncerramentoExeDetListPage({Key? key}) : super(key: key);
