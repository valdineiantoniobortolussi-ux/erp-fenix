...
class ContabilLancamentoCabecalhoListPage extends GetView<ContabilLancamentoCabecalhoController> {
	const ContabilLancamentoCabecalhoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Lancamento Contábil'),
				actions: [
