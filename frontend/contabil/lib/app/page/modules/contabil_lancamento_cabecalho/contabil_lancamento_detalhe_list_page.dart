...
class ContabilLancamentoDetalheListPage extends GetView<ContabilLancamentoDetalheController> {
	const ContabilLancamentoDetalheListPage({Key? key}) : super(key: key);
