...
class EsocialTipoAfastamentoListPage extends GetView<EsocialTipoAfastamentoController> {
	const EsocialTipoAfastamentoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Tipo Afastamento'),
				actions: [
