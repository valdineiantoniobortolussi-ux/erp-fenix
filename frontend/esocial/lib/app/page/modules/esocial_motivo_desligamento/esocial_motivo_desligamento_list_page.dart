...
class EsocialMotivoDesligamentoListPage extends GetView<EsocialMotivoDesligamentoController> {
	const EsocialMotivoDesligamentoListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Motivo Desligamento'),
				actions: [
