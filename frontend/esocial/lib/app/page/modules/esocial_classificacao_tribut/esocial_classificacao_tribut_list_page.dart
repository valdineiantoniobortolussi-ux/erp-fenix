...
class EsocialClassificacaoTributListPage extends GetView<EsocialClassificacaoTributController> {
	const EsocialClassificacaoTributListPage({Key? key}) : super(key: key);
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Classificação Tributária'),
				actions: [
