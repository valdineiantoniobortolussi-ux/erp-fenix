...
import 'dart:math';
import 'package:gondolas/app/controller/theme_controller.dart';
              ...
              style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 10.0),
					...
					ListTile(
						enabled: Session.loggedInUser.administrador == 'S'
							? true
								: Session.accessControlList.where( ((t) => t.funcaoNome == 'gondola_rua') ).toList().isNotEmpty
									? Session.accessControlList.where( ((t) => t.funcaoNome == 'gondola_rua') ).toList()[0].habilitado == 'S'
									: false,
						onTap: () {
							Get.toNamed(Routes.gondolaRuaListPage);
						},
						title: const Text(
							'Rua',
					...
					ListTile(
						enabled: Session.loggedInUser.administrador == 'S'
							? true
								: Session.accessControlList.where( ((t) => t.funcaoNome == 'gondola_estante') ).toList().isNotEmpty
									? Session.accessControlList.where( ((t) => t.funcaoNome == 'gondola_estante') ).toList()[0].habilitado == 'S'
									: false,
						onTap: () {
							Get.toNamed(Routes.gondolaEstanteListPage);
						},
						title: const Text(
							'Estante',
							style: TextStyle(fontWeight: FontWeight.w700, fontSize: 18.0),
            ...
            child: Text(
              ...
              style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 10.0),
					...
					ListTile(
						enabled: Session.loggedInUser.administrador == 'S'
							? true
								: Session.accessControlList.where( ((t) => t.funcaoNome == 'gondola_caixa') ).toList().isNotEmpty
									? Session.accessControlList.where( ((t) => t.funcaoNome == 'gondola_caixa') ).toList()[0].habilitado == 'S'
									: false,
						onTap: () {
							Get.toNamed(Routes.gondolaCaixaListPage);
						},
						title: const Text(
							'Caixa',
							style: TextStyle(fontWeight: FontWeight.w700, fontSize: 18.0),
