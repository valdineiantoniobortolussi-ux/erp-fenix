...
class OrcamentoFluxoCaixaDetalheListPage extends GetView<OrcamentoFluxoCaixaDetalheController> {
	const OrcamentoFluxoCaixaDetalheListPage({Key? key}) : super(key: key);
